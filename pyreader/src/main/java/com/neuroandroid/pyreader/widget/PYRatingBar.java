...
public class PYRatingBar extends LinearLayout {
    /**
     * 是否可点击
     */
     ...
     * @param attrs
     */
    public PYRatingBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        setOrientation(LinearLayout.HORIZONTAL);
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.RatingBar);
        starImageSize = mTypedArray.getDimension(R.styleable.RatingBar_star_image_size, 20);
        starPadding = mTypedArray.getDimension(R.styleable.RatingBar_star_padding, 10);
        starStep = mTypedArray.getFloat(R.styleable.RatingBar_star_step, 1.0f);
        stepSize = StepSize.fromStep(mTypedArray.getInt(R.styleable.RatingBar_step_size, 1));
        starCount = mTypedArray.getInteger(R.styleable.RatingBar_star_count, 5);
        starEmptyDrawable = mTypedArray.getDrawable(R.styleable.RatingBar_star_empty);
        starFillDrawable = mTypedArray.getDrawable(R.styleable.RatingBar_star_fill);
        starHalfDrawable = mTypedArray.getDrawable(R.styleable.RatingBar_star_half);
